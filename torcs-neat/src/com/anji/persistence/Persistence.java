 ...
 */
String PERSISTENCE_CLASS_KEY = "persistence";
 ...
 * @throws Exception
 */
void store(Chromosome c) throws Exception;

/**
 * @param a activator to store
 * @throws Exception
 */
void store(Activator a) throws Exception;

/**
 * @param r run to store
 * @throws Exception
 */
void store(Run r) throws Exception;
 ...
 * @throws Exception
 */
void deleteChromosome(String id) throws Exception;
 ...
 */
Chromosome loadChromosome(String id, Configuration config);
